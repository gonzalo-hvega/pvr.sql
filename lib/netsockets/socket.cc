...
net_socket_t::net_socket_t() : m_sockfd(0)
{
...
net_socket_t::net_socket_t(socketfd_t sockfd, sockaddr_in sock_addr) :
  m_sockfd(sockfd),
...
int net_socket_t::write_all(const void* _buf, int size_buf)
{
...
int net_socket_t::read_all(void* _buf, int size_buf)
{
...
net_socket_t tcp_server_t::accept()
{
  ...
  net_socket_t socket(fd, addr_client);
  return socket;
}
